...
export const App = {
  ...
  settings:{autoScroll:true, timestamps:true, autoDetect:true, highlightTerms:false, autoCoding:true, dentalChartInExport:true, dentalFindingsInExport:true, showCopyEhr:false, showExportHl7:false, showNarrative:false, showSyncPms:false, showDocScore:false},
